...
// $fichier_naissance=$_POST["fichier_naissance[]"];
/*echo"
$annee_registre 
$num_registre 
$type_declaration 
...
$connect=new PDO("mysql:host=localhost;port=3306;dbname=ecivil","root","");
		...
		{ 
			...
			$stmt->bindParam(13, $nbr_naissance);
			$stmt->bindParam(14, $cni_pere);
			$stmt->bindParam(15, $prenom_pere);
			$stmt->bindParam(16, $nom_pere);
			$stmt->bindParam(17,$date_naissance_pere);
			$stmt->bindParam(18, $lieu_naissance_pere);
			$stmt->bindParam(19, $domicile_pere);
			$stmt->bindParam(20, $profession_pere);
			$stmt->bindParam(21, $cni_mere);
			$stmt->bindParam(22,$prenom_mere);
			$stmt->bindParam(23, $nom_mere);
			$stmt->bindParam(24, $date_naissance_mere);
			$stmt->bindParam(25, $lieu_naissance_mere);
			$stmt->bindParam(26, $domicile_mere);
			$stmt->bindParam(27,$profession_mere);
			$stmt->bindParam(28, $parent);
			$stmt->bindParam(29, $pere_mere);
			$stmt->bindParam(30, $cni_declarant);
			$stmt->bindParam(31, $prenom_declarant);
			$stmt->bindParam(32,$nom_declarant);
			$stmt->bindParam(33, $date_naissance_declarant);
			$stmt->bindParam(34, $lieu_naissance_declarant);
			$stmt->bindParam(35, $domicile_declarant);
			$stmt->bindParam(36, $profession_declarant);
			$stmt->bindParam(37,$degre_parente);
			$stmt->execute();
		}
		else
		{
