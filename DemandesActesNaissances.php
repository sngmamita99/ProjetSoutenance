...
<body >
    ...
    <div class="container white" >
        <div class="row">
            <form class="col s12 m12 l12" method="POST" action="e_demande_acte_trmnt.php">
                ...
                <div class="row">
                    <div class="input-field col s6 m2 l2">
                        <input type="number" required min="1980" max="2021" name="annee_acte"
                            id="annee_acte">
                        <label for="annee_acte">Année du registre</label>
                    </div>
                    <div class="input-field col s6 m2 l2">
                        <input type="number" required min="1" name="num_acte" id="num_acte">
